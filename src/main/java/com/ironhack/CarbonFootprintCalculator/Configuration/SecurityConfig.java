...
import com.ironhack.CarbonFootprintCalculator.Configuration.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf().disable()
                .authorizeRequests(authorizeRequests ->
                        authorizeRequests
                                .antMatchers("/zhyMuseum/auth/**", "/zhyMuseum/artist/**", "/zhyMuseum/**").permitAll()
...
//                        request.antMatchers("/users/**", "/individual-users/**")
//                                .authenticated()
